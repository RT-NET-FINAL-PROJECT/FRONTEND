...
import { uploadProfileKtp } from "../stores/action/actionCreator";

export default function ProfileKtp({ currentLoggedIn, navigation }) {
  ...
  const uploadImage = async () => {
    ...
    try {
      await dispatch(uploadProfileKtp(image, navigation));

      setIsEditing(false);
      await Alert.alert("", `Upload foto KTP success.`, [
